...
### Missing by Genres
  ...
  - We are now investigating the missing values of runtime by each genre
...
- Missing patterns vary by types. For example, movies do not have `endYear` and talk shows do not have `runtimeMinutes` or `genres`.
